...
return [
    ...
    [ // $dynamicRoutes
        ...
        196 => [[['_route' => 'career_summary_show', '_controller' => 'App\\Controller\\CareerSummaryController::show'], ['id'], ['GET' => 0], null, false, true, null]],
        209 => [[['_route' => 'career_summary_edit', '_controller' => 'App\\Controller\\CareerSummaryController::edit'], ['id'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        217 => [
            [['_route' => 'career_summary_delete', '_controller' => 'App\\Controller\\CareerSummaryController::delete'], ['id'], ['DELETE' => 0], null, false, true, null],
